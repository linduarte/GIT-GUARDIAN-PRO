""" This file is charging of generate  repos """
import json
import os
...
def generate():
    """Generate a repos.json describing local git repositories.

    Scans configured root folders for subdirectories containing a .git
    directory and writes the resulting mapping to repos.json and
    main.dist/repos.json.
    """
